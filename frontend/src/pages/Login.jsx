  ...
  return (
    <div className="flex min-h-screen bg-slate-50 overflow-hidden font-sans">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  type="email"
                  required
                  className="block w-full rounded-xl border-slate-200 bg-white/50 px-4 py-3 text-slate-900 placeholder-slate-400 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 transition-all sm:text-sm"
      ...
      <div className="hidden lg:flex lg:w-1/2 mesh-bg relative items-center justify-center p-12">
        ...
        >
          <motion.div variants={fadeUp} className="mb-8 inline-flex items-center px-4 py-2 rounded-full bg-white/40 backdrop-blur-md border border-white/50 text-indigo-800 font-bold text-sm shadow-sm">
            <Sparkles className="w-4 h-4 mr-2 text-indigo-600" /> Hackathon Edition
          </motion.div>
          
          <motion.h1 variants={fadeUp} className="text-5xl font-extrabold text-slate-900 leading-[1.1] mb-6 tracking-tight">
          ...
          <motion.p variants={fadeUp} className="text-lg text-slate-700 font-medium mb-10 leading-relaxed">
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div key={idx} variants={fadeUp} className="flex items-start p-4 bg-white/40 backdrop-blur-md rounded-2xl border border-white/50 shadow-sm">
                <div className="bg-white p-2.5 rounded-xl shadow-sm mr-4 text-indigo-600">
                  <feature.icon className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="font-bold text-slate-900">{feature.title}</h3>
                  <p className="text-sm text-slate-600 font-medium mt-0.5">{feature.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
